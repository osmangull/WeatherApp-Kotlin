package com.interyazilim.weatherapp.viewmodel

import android.util.Log
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.interyazilim.weatherapp.model.WeatherModel
import com.interyazilim.weatherapp.service.WeatherAPIService
...
class MainViewModel : ViewModel() {
    ...
    val weather_error = MutableLiveData<Boolean>() // if this value is false// observer run and error screen is active
